...
class DownloadDatasource {
  ...
  DownloadDatasource(this._audios, this._downloadDir) {
    _filesDatasource = FilesDatasource(parent: _downloadDir);
  }

  Future<String> downloadVideo(VideoStreamInfo video, String title) async {
    ...
    print('Video path: $downloadedVideo');
    print('Audio path: $downloadedAudio');
